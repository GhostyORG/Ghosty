...
module.exports = async (client) => {
    ...
    const apiLimiter = rateLimit({
        ...
        message: ({
            error: true,
            message: "Too many requests, you have been rate limited. Please try again in one hour."
        })
    });
    ...
    http.listen(80, () => {
        console.log("[GhostyLists]: Website running on 80 port.")
    });
    ...
    */
    console.log(`
      [===========================================]
                       GhostyLists
        https://github.com/GhostyORG/Ghosty
                Developed by Ghosty Team
    ...
    sleep(1050)
    console.clear();
    console.log('\x1b[36m%s\x1b[0m', "[GhostyList]: General routers loading...");
    sleep(500);
    ...
    /* Uptime System */
    console.log(" ")
    console.log('\x1b[36m%s\x1b[0m', "[GhostyList]: Uptime system routers loading...");
    sleep(500);
    ...
    /* Profile System */
    console.log(" ")
    console.log('\x1b[36m%s\x1b[0m', "[GhostyList]: Profile system routers loading...");
    sleep(500);
    ...
    /* Code Share System */
    console.log(" ")
    console.log('\x1b[36m%s\x1b[0m', "[GhostyList]: Code Share system routers loading...");
    sleep(500);
    ...
    /* Botlist System */
    console.log(" ")
    console.log('\x1b[36m%s\x1b[0m', "[GhostyList]: Botlist system routers loading...");
    sleep(500);
    ...
    /* Server List System */
    console.log(" ")
    console.log('\x1b[36m%s\x1b[0m', "[GhostyList]: Serverlist system routers loading...");
    sleep(500);
    ...
    app.use(async (req, res, next) => {
        if (req.path.includes('/admin')) {
            if (req.isAuthenticated()) {
                if (client.guilds.cache.get(config.server.id).members.cache.get(req.user.id).roles.cache.get(global.config.server.roles.administrator) || client.guilds.cache.get(config.server.id).members.cache.get(req.user.id).roles.cache.get(global.config.server.roles.moderator) || req.user.id === "719660045817872394") {
                    next();
                } else {
    ...
    console.log(" ")
    console.log('\x1b[36m%s\x1b[0m', "[GhostyLists]: Admin Panel system routers loading...");
    sleep(500);
    ...
    /* Bot System */
    console.log(" ")
    console.log('\x1b[36m%s\x1b[0m', "[GhostyLists]: Bot system loading...");
