...
console.log("[GhostyLists]: Botlist/Vote router loaded.");
...
.setName("GhostyLists Votes Manager")
.setAvatar(client.user.displayAvatarURL())
.setAuthor("Vote Logs", client.user.displayAvatarURL(), "https://ghostylists.xyz")
.setColor("#800080")
