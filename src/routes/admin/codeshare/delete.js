...
console.log("[GhostyLists]: Admin/CodeShare/Delete router loaded.");
...
app.post("/admin/deletecode/:code", global.checkAuth, async (req, res) => {
    ...
    client.channels.cache.get(channels.codelog).send(new Discord.MessageEmbed()
        ...
        .setDescription(`The user named **[${req.user.username}](https://ghostylists.xyz/user/${req.user.id})** deleted the code named **${kodDataFind.codeName}**.`)
