...
console.log("[GhostyLists]: Mini pages router loaded.");
...
app.get("/robots.txt", function (req, res) {
    ...
    res.send(`Sitemap: https://ghostylists.xyz/sitemap.xml`);
});

app.get("/sitemap.xml", async function (req, res) {
    let link = "<url><loc>https://ghostylists.xyz/</loc></url>";
    let botdataforxml = await botsdata.find()
    botdataforxml.forEach(bot => {
        link += "\n<url><loc>https://ghostylists.xyz/bot/" + bot.botID + "</loc></url>";
    })
